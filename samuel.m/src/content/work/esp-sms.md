---
title: "ESP-SMS: hardware vision pipeline"
date: 2025-12-01
tags: [embedded, esp32, c, fastapi, vision]
category: project
excerpt: "A hardware-and-software pipeline that takes a photo with an ESP32-CAM, sends it to an OpenAI vision model, and pushes the result to a phone via Pushover."
---
