...
category: writeup
excerpt: "Exploiting Redis LRU eviction as an oracle to extract a secret through CSS injection, when CSP and network restrictions block conventional exfiltration."
---
