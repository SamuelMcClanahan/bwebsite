---
name: "ESP-SMS"
tag: "embedded · esp32 · c · fastapi"
status: shipped
year: "2025"
summary: "A hardware pipeline that takes a photo with an ESP32-CAM, sends it to an OpenAI vision model, and pushes the result to a phone via Pushover."
---
