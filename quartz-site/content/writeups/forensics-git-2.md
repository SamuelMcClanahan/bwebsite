...
description: Recovering a deleted file from a Git repository embedded in a raw disk image using The Sleuth Kit and Git object plumbing.
...
- [[paper-2]], [[defcon-livectf-2026]] — more CTF writeups
- [[cv]]
